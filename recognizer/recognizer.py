...
class Recognizer:
    ...
    def inputs(self, files, num_examples_per_epoch_for_train=3000):
        queues = {}
        ...
        def read_files(files):
            ...
            label_bytes = 1           # label is 1 byte
            image_bytes = Recognizer.IMAGE_SIZE * Recognizer.IMAGE_SIZE * Recognizer.IMAGE_DEPTH # height 64 * width 64 * depth 3
            ...
            depth_major = tf.reshape(tf.slice(record_bytes, [label_bytes], [image_bytes]),
                                    [Recognizer.IMAGE_DEPTH, Recognizer.IMAGE_SIZE, Recognizer.IMAGE_SIZE])
            ...
            return [tf.image.per_image_whitening(image), label[0]]
